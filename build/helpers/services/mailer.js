...
exports.sendVerification = (name, phone, lesson, email) => {
    const html = `
    <html lang="en">
      <head>
        <meta charset="utf-8">
...
exports.sendEmailUser = (name, phone, lesson, email) => {
    const html = `
  <!doctype html>
...
exports.sendAppliement = (name, phoneNumber, city, companyName, category, comment) => {
    const html = `
    <html lang="en">
      <head>
        <meta charset="utf-8">
            ...
            <div style="min-height: 160px;border: 2px solid #760E4D;margin-top: 20px;border-radius: 5px;padding: 10px 25px;font-size: 14px;">
              ...
              <div style="width: 100%; height: 100%; padding : 20px 0;">
                ...
                <p style="font-size: 18px;margin: 0; line-height: 35px; text-align: center;">Company Name : ${companyName}</p>
                  ...
                  <p style="font-size: 18px;margin: 0; line-height: 35px; text-align: center;">Comment : ${comment || "-"}</p>
...
exports.sendHybrid = (name, email, message) => {
    const html = `
    <html lang="en">
      <head>
        <meta charset="utf-8">
...
exports.sendFDA = (name, email, message) => {
    const html = `
    <html lang="en">
      <head>
        <meta charset="utf-8">

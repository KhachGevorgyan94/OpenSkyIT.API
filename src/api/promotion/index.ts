...
class Controller {
  ...
  public router: Router;
    ...
    //#endregion
		...
		this.router.delete('/Delete/:id', isAuthenticated([ UserRole.admin ]), Validations.deleteBlog, this.delete);
	}

	private delete = async (req: IRequest, res: Response) => {
		try {
			const data: IResponseObjectViewModel = await Services.deleteBlog(req.params.id);
